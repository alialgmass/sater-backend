...
class ProductSearchDTO
{
    ...
    public static function rules(): array
    {
        return [
            ...
            'fabric_type' => ['nullable', 'string', 'in:' . implode(',', \App\Enums\FabricTypeEnum::values())],
            'sleeve_length' => ['nullable', 'string', 'in:' . implode(',', \App\Enums\SleeveLengthEnum::values())],
            'opacity_level' => ['nullable', 'string', 'in:' . implode(',', \App\Enums\OpacityLevelEnum::values())],
            'hijab_style' => ['nullable', 'string', 'in:' . implode(',', \App\Enums\HijabStyleEnum::values())],
            'sort' => ['nullable', 'string', 'in:' . implode(',', \App\Enums\SortOptionEnum::values())],
